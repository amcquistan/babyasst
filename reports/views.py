...
from babybuddy.mixins import ChildActivityTestMixin
from core import models

from . import graphs


class DiaperChangeLifetimesChildReport(ChildActivityTestMixin, DetailView):
    """
...
class DiaperChangeTypesChildReport(ChildActivityTestMixin, DetailView):
    """
...
class FeedingAmountsChildReport(ChildActivityTestMixin, DetailView):
    """
...
class FeedingDurationChildReport(ChildActivityTestMixin, DetailView):
    """
...
class SleepPatternChildReport(ChildActivityTestMixin, DetailView):
    """
...
class SleepTotalsChildReport(ChildActivityTestMixin, DetailView):
    """
...
class WeightWeightChildReport(ChildActivityTestMixin, DetailView):
    """
