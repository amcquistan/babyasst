...
9	pbkdf2_sha256$150000$kjiC7Kr16q6U$+tySyD1H0Kh7anaa5MO7V6Qg7kDjQQVgA55syaxwevM=	2019-12-12 07:45:12.335965+00	f	Jfullen12	Jenna	Fullen	jenna.propp@gmail.com	f	t	2019-12-12 07:45:12.08123+00
...
10	pbkdf2_sha256$150000$mm68f07Xr9eD$Xm4D+DNBhWC7cPSsDCS4w53scL4oTO0YbEgOLJ2V6+k=	2019-12-12 13:16:01.686337+00	f	Bess	Bess	Jones	bessrapp@gmail.com	f	t	2019-12-12 13:16:01.478461+00
...
9	Fullen	\N	9	t	fullen
10	Jones	\N	10	t	jones
...
5	Maggie	Fullen	2019-11-21	fullen-maggie		9	t
6	Caroline	Jones	2019-12-08	jones-caroline		10	t
\.
...
275	2019-12-12 09:29:00+00	t	f	yellow	2
276	2019-12-12 12:59:00+00	t	f	yellow	2
277	2019-12-12 13:46:00+00	t	f	yellow	5
278	2019-12-12 11:15:00+00	f	t	yellow	5
279	2019-12-12 12:59:00+00	t	f	yellow	2
\.
...
331	2019-12-12 07:38:00+00	2019-12-12 07:48:00+00	00:10:00	breast milk	both breasts	\N	5	ounces
332	2019-12-12 09:10:00+00	2019-12-12 09:29:00+00	00:19:00	formula	bottle	4	2	ounces
333	2019-12-12 12:31:00+00	2019-12-12 12:58:00+00	00:27:00	formula	bottle	4	2	ounces
335	2019-12-12 11:15:00+00	2019-12-12 11:48:00+00	00:33:00	breast milk	both breasts	\N	5	ounces
334	2019-12-12 13:15:00+00	2019-12-12 13:30:00+00	00:15:00	breast milk	right breast	\N	6	ounces
\.
...
3	Bess Meds\n0800	2019-12-12 14:52:43.90654+00	6
\.
...
128	2019-12-12 06:07:00+00	2019-12-12 09:09:00+00	03:02:00	2
129	2019-12-12 09:30:00+00	2019-12-12 12:00:00+00	02:30:00	2
\.
...
353	Timer #353	2019-12-12 12:58:55.409088+00	2019-12-12 12:58:55.432704+00	00:27:19.889437	f	4	3	2	t	f	f	t	2019-12-12 12:31:35.287711+00
...
352	Timer #352	2019-12-12 09:29:25.079246+00	2019-12-12 09:29:25.103117+00	00:19:08.207845	f	4	3	2	t	f	f	t	2019-12-12 09:10:16.790685+00
\.
...
3kjcbvtnb57bswz51ondzecn5g26rjmd		2019-12-26 07:45:14.208485+00
s7r4fowqi5c00dcsmt2gq2zfoecc85lw		2019-12-26 13:16:03.577152+00
\.
...
SELECT pg_catalog.setval('public.babybuddy_account_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.babybuddy_account_users_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.babybuddy_accountmembersettings_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.babybuddy_settings_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.core_bath_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.core_child_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.core_diaperchange_id_seq', 279, true);
...
SELECT pg_catalog.setval('public.core_feeding_id_seq', 335, true);
...
SELECT pg_catalog.setval('public.core_note_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.core_sleep_id_seq', 129, true);
...
SELECT pg_catalog.setval('public.core_timer_id_seq', 353, true);
